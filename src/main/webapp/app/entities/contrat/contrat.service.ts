...
export class ContratService {
  ...
  protected convertDateFromClient(contrat: IContrat): IContrat {
    const copy: IContrat = Object.assign({}, contrat, {
      dateDebut: contrat.dateDebut && contrat.dateDebut.isValid() ? contrat.dateDebut.format(DATE_FORMAT) : undefined,
      dateFin: contrat.dateFin && contrat.dateFin.isValid() ? contrat.dateFin.format(DATE_FORMAT) : undefined,
    });
    return copy;
  }
