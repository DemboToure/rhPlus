package com.rhplus.rhplus.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.rhplus.rhplus.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.rhplus.rhplus.repository.UserRepository.USERS_BY_EMAIL_CACHE);
