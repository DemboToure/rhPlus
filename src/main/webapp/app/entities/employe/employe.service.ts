...
export class EmployeService {
  ...
  protected convertDateFromClient(employe: IEmploye): IEmploye {
    const copy: IEmploye = Object.assign({}, employe, {
      ...
      dateEmbauche: employe.dateEmbauche && employe.dateEmbauche.isValid() ? employe.dateEmbauche.format(DATE_FORMAT) : undefined,
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((employe: IEmploye) => {
        ...
        employe.dateEmbauche = employe.dateEmbauche ? moment(employe.dateEmbauche) : undefined;
      });
    }
    return res;
  }
